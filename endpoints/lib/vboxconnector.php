...
class vboxconnector {
    ...
    $this->$pvbxver = substr(@constant('PHPVBOX_VER'),0,(strpos(@constant('PHPVBOX_VER'),'-')));
    $this->client = new SoapClient(dirname(__FILE__)."/vboxwebService-".$this->$pvbxver.".wsdl",
		    array(
	 ...
	 *
	 * @param array $args array of arguments. See function body for details.
   *        array $args consists of following parts:
   *         - 'file'     - (mandatory) - settings of vm added,
   *         - 'password' - (optional)  - password (if added machine is encrypted).
	 * @return boolean true on success
	 */
	public function remote_machineAdd($args) {
		...
		/* @var $m IMachine */
		$m = $this->vbox->openMachine($args['file'], $args['password']);
	 ...
	 * in vboxServiceWrappers-7.0.php (classes that extend VBox_Enum).
	 *
	 * @param array $args array of arguments. See function body for details.
	 * @return array response data
	 * @see vboxServiceWrappers-7.0.php
	 */
